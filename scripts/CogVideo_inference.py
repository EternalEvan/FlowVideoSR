...
def generate_video(
    prompt: str,
    model_path: str,
    output_path: str = "./output_17frames.mp4",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, default="/mnt/nfs/CogVideoX-2b", help="The path of the pre-trained model to be used"
    )
    parser.add_argument(
        "--output_path", type=str, default="/home/whl/workspace/output.mp4", help="The path where the generated video will be saved"
    )
    parser.add_argument(

...
from diffusers import CogVideoXPipeline, CogVideoXDDIMScheduler, CogVideoXDPMScheduler, CogVideoXTransformer3DModel
import os
import torch
import argparse
...
if __name__ == "__main__":
    ...
    # print(f'transformer_lora_parameters = {transformer_lora_parameters}')

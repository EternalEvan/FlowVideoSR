...
class PixArt(nn.Module):
    ...
    def __init__(
        ...
        self.x_embedder = PatchEmbed3D(patch_size, in_channels, hidden_size)#PatchEmbed(input_size, patch_size, in_channels, hidden_size, bias=True)
        self.t_embedder = TimestepEmbedder(hidden_size)
        ...
        self.num_temporal = input_size[0] // patch_size[0]
        self.num_spatial = num_patches // self.num_temporal
        self.base_size = input_size[1] // self.patch_size[1]  # ?
        # Will use fixed sin-cos embedding:
        self.register_buffer("pos_embed", torch.zeros(1, num_patches, hidden_size))  # get_spatial_pos_embed, get_temporal_pos_embed

...
save_dir = "./samples_apple/CogVideoX_lora_controlnext_9frames_nocache_full_step60000-5step/samples"
save_dir1 = "./samples_apple/CogVideoX_lora_controlnext_9frames_nocache_full_step60000-5step/lq"
save_dir2 = "./samples_apple/CogVideoX_lora_controlnext_9frames_nocache_full_step60000-5step/hq"
...
dataset = dict(
    ...
    opt = dict(
        name = "test_dataset", 
        dataroot_gt='/mnt/nfs/Apple-Test/20241119_synthetic_data_share/gt',#'/mnt/nfs/train51/train_sharp',#"/mnt/nfs/YouHQ-Train",

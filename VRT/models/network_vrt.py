...
class SimpleVRT(nn.Module):
    """ Video Restoration Transformer (VRT).
        A PyTorch impl of : `VRT: A Video Restoration Transformer`  -
          https://arxiv.org/pdf/2201.00000
          Simplified version of VRT
    ...
    def __init__(self,
        ...
        self.stage1 = Stage(
                        in_dim=embed_dims[-1],
                        dim=embed_dims[0],
                        input_resolution=(img_size[0], img_size[1] // scales[0], img_size[2] // scales[0]),
                        depth=depths[0],
                        ...
                        deformable_groups=deformable_groups,
                        reshape=reshapes[0],
                        max_residue_magnitude=10 / scales[0],
